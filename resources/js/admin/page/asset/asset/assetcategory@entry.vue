              ...
              <tr v-for="(shopAssetCategoryList, index) in shopAssetCategoryLists.data">
                ...
                <td>
                  <div v-if="shopAssetCategoryList.assetCategoryStatus == 1">
                    <button type="button"   class="btn btn-hover-shine btn-success">Publish</button>
                  </div>
                  <div v-else>
                ...
                <td>
                   <router-link :to="`/category@Edit${shopAssetCategoryList.assetCategoryI}`" class="btn btn-hover-shine  btn-primary"><i class=" fa fa-edit"></i>Edit</router-link>
                </td>
            </tr>
          </tbody>
        </table>

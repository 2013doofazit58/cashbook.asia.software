          ...
          <thead>
            ...
            <tbody>
              <tr v-for="(brandData, index) in assetBrandData.data">
                ...
                <td>
                     <router-link :to="`/shopAssetBrand@entryEdit${brandData.assetBrandEntryId}`" class="btn btn-hover-shine  btn-primary"><i class=" fa fa-edit"></i>Edit</router-link>
<<<<<<< HEAD

=======
<<<<<<< HEAD
>>>>>>> 8105361e1eaf2b773db1409274892c8a937ce71c
...
=======
=======
>>>>>>> c4c6df7bf2391e0ed068c06f81e0e736fe0f64d4
>>>>>>> 8105361e1eaf2b773db1409274892c8a937ce71c
                </td>
              </tr>
            </tbody>
        ...
        methods:{
            ...
            getShopAssetData(){
                axios.get('/shopAssetBrandEntry').then(res=>{
                    this.assetBrandData = res.data.shopAssetData;
                })
